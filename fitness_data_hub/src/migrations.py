...
def migrate_provider_identity(engine: Engine) -> None:
    """Add provider identity columns to existing SQLite installations.

    Fresh installations get the columns from SQLAlchemy metadata. Existing
    databases created before 0.2.4 are upgraded in place and backfilled as
    Strava, preserving all current data.
    """
